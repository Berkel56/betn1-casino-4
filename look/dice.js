...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-e792a5db');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-e792a5db');}
...
var brandEl=document.querySelector('.rl-brand-e792a5db');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
